...
class Anuncios {
	...
	public function getUltimosAnuncios($page, $perPage, $filtros) {
		global $pdo;
                //* pela quantidade de itens que aparecer na pagina
   ...
   //pega todos os anuncios do usuario logado
			...
			for($q=0;$q<count($fotos['tmp_name']);$q++) {
				...
				if(in_array($tipo, array('image/jpeg', 'image/png'))) {
					...
					$ratio = $width_orig/$height_orig;
                                        //tamanho padrao das imagens dentro do sistema
					$width = 500;
					$height = 500;
                                         //realizando a alteração da imagem
